...
<!--_________________sidenav_______________-->
  ...
  <div class="h"><a href="expired.php">Return Books</a></div>
</div>
...
<div id="main">
  ...
  <div class="container">
    <h2 style="text-align: center; font-size: 35px; font-family: Times New Roman;">History of Books taken from Library</h2>
    <?php
    $c=0;
    ...
    echo "</table>";
      ...
      {
        ?>
          <h3 style="font-family: Times New Roman; color: mediumblue">Login to see History of Books taken from Library.</h3>
        <?php
      }
    ?>
  </div>

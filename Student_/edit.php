...
<body style="background-color: peachpuff;">
	...
	<h2 style="text-align: center;color: black;font-family: Times New Roman;">Edit Information</h2>
	<?php
	...
	<div class="profile_info" style="text-align: center;">
		<span style="color: black;font-family: Times New Roman;">Welcome,</span>	
		<h4 style="color: black;font-family: Times New Roman;"><?php echo $_SESSION['login_user']; ?></h4>
	</div><br><br>

...
<!--_________________sidenav_______________-->
  ...
  <div class="h"><a href="expired.php">Returned Books</a></div>
</div>
...
<div class="container">
	...
	<h2 style="text-align: center; font-family: Times New Roman;">Book Requests to be approved</h2>
	...
	if(isset($_SESSION['login_user']))
	{
		...
		if(mysqli_num_rows($res)==0)
			{
				echo "<h3 style='font-family: Times New Roman; color: purple'>";
	...
	else
	{
		?>
		<br>
			<h3 style = "color: purple; font-family: Times New Roman;">Login to see the request.</h3>

...
<div id="main">
  ...
  <div class="container">
    <h2 style="text-align: center; font-family: Times New Roman;"> History of Books Issued </h2>
    <?php
    $c=0;
    ...
    echo "</table>";
      ...
      {
        ?>
          <h3 style="font-family: Times New Roman; color: mediumorchid ">Login to see the History of Books Issued.</h3>
        <?php
      }
    ?>
  </div>

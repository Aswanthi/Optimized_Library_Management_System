...
<div id="main">
  ...
  <div class="container">
    <br><h3 style="text-align: center;font-family: Times New Roman">Approve Request</h3><br><br>
    ...
    <form class="Approve" action="" method="post">
        ...
        <button style="text-align: center;"class="btn btn-default" type="submit" name="submit">Approve</button>
    </form>
